...
for gt_path in tqdm(sorted(glob.glob("/home/ubuntu/TextFuseNet/datasets/test/Task1_GT/*"))):
    idx = os.path.basename(gt_path)[3:].split('.')[0]
    img_path = "/home/ubuntu/TextFuseNet/datasets/test/train_images/ICDAR2013_Train_"+idx+".jpg"
...
with open("/home/ubuntu/TextFuseNet/datasets/test/train_pretty.json", 'w') as outfile:
    json.dump(datasets, outfile, indent=4)

with open("/home/ubuntu/TextFuseNet/datasets/test/train.json", 'w') as outfile:
