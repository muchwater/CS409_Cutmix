...
for gt_path in tqdm(sorted(glob.glob("/home/ubuntu/TextFuseNet/datasets/icdar2013/Task1_GT/*"))):
    idx = os.path.basename(gt_path)[3:].split('.')[0]
    img_path = "/home/ubuntu/TextFuseNet/datasets/resized_icdar2013/train_images/ICDAR2013_Train_"+idx+".jpg"
...
with open("/home/ubuntu/TextFuseNet/datasets/resized_icdar2013/train_pretty.json", 'w') as outfile:
    json.dump(datasets, outfile, indent=4)

with open("/home/ubuntu/TextFuseNet/datasets/resized_icdar2013/train.json", 'w') as outfile:
